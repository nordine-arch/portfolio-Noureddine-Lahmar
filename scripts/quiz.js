...
const QUIZZES = {
  ...
  hardware: {
    ...
    icon: "🧩",
    description:
      "Processeur, mémoire, stockage, alimentation et refroidissement : identifiez les composants essentiels d’un ordinateur.",
    questions: [
      {
        question: "Quel est le rôle principal du processeur, ou CPU ?",
        answers: [
          "Exécuter les instructions et traiter les opérations",
          "Alimenter électriquement tous les composants",
          "Stocker définitivement les fichiers personnels"
        ],
        correct: 0,
        explanation:
          "Le CPU exécute les instructions nécessaires au système d’exploitation et aux programmes. Il coordonne une grande partie des traitements de l’ordinateur.",
        source:
          "https://www.intel.com/content/www/us/en/products/docs/processors/cpu-vs-gpu.html"
      },
      {
        question: "Dans quels emplacements installe-t-on les barrettes de mémoire vive ?",
        answers: [
          "Dans les connecteurs SATA",
          "Dans les emplacements DIMM de la carte mère",
          "Dans le socket du processeur"
        ],
        correct: 1,
        explanation:
          "Les barrettes de mémoire s’installent dans les emplacements DIMM. Leur position doit respecter les recommandations du manuel de la carte mère, notamment pour le fonctionnement en double canal.",
        source: "https://www.asus.com/support/faq/1047257/"
      },
      {
        question: "Quelle différence matérielle caractérise principalement un SSD par rapport à un HDD ?",
        answers: [
          "Le SSD utilise obligatoirement des disques magnétiques",
          "Le SSD stocke les données sans pièces mécaniques mobiles",
          "Le SSD ne peut pas conserver les données hors tension"
        ],
        correct: 1,
        explanation:
          "Un SSD s’appuie sur de la mémoire électronique et ne contient pas de plateaux ni de tête de lecture mécanique, contrairement à un disque dur traditionnel.",
        source: "https://www.ibm.com/think/topics/solid-state-drives"
      },
      {
        question: "À quoi sert le bloc d’alimentation d’un ordinateur ?",
        answers: [
          "À convertir et distribuer l’énergie électrique aux composants",
          "À refroidir directement le processeur avec de l’eau",
          "À augmenter automatiquement la capacité du SSD"
        ],
        correct: 0,
        explanation:
          "Le PSU convertit l’électricité provenant du secteur en tensions continues utilisables et fournit l’énergie nécessaire à la carte mère, au processeur, au GPU et aux périphériques.",
        source:
          "https://www.corsair.com/us/en/explorer/diy-builder/power-supply-units/what-is-a-psu-power-supply-units-explained/"
      },
      {
        question: "Quel est le rôle de la pâte thermique entre le processeur et son refroidisseur ?",
        answers: [
          "Coller définitivement le processeur à la carte mère",
          "Améliorer le transfert de chaleur entre les surfaces",
          "Isoler le processeur de toute dissipation thermique"
        ],
        correct: 1,
        explanation:
          "La pâte thermique comble les très petites irrégularités entre le processeur et la base du refroidisseur afin de favoriser le transfert de chaleur.",
        source:
...
function renderThemeNavigation() {
  ...
  themeOrder.forEach((key) => {
    ...
    link.href = `quiz.html?theme=${key}&v=3`;
